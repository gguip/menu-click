...
export const TIMEZONES: readonly { value: string; label: string }[] = [
  ...
  { value: "America/Maceio", label: "Alagoas e Sergipe (America/Maceio)" },
  { value: "America/Belem", label: "Pará (America/Belem)" },
  { value: "America/Araguaina", label: "Tocantins (America/Araguaina)" },
  { value: "America/Manaus", label: "Amazonas (America/Manaus)" },
  { value: "America/Boa_Vista", label: "Roraima (America/Boa_Vista)" },
  { value: "America/Cuiaba", label: "Mato Grosso (America/Cuiaba)" },
  { value: "America/Campo_Grande", label: "Mato Grosso do Sul (America/Campo_Grande)" },
